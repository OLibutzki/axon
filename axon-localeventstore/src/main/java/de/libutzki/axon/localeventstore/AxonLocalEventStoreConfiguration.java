...
public class AxonLocalEventStoreConfiguration {
	...
	@Bean
	@Primary
	EventStore localAndGlobalEventStoreAdapter( final EventStorageEngine storageEngine, @Qualifier( "eventStore" ) final EventStore globalEventStore, final org.axonframework.config.Configuration configuration) {
		...
		return new LocalAndGlobalEventStoreAdapter( localEventStore, globalEventStore );
	}
